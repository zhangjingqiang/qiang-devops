...
class StacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stack" do
    assert_difference('Stack.count') do
      post stacks_url, params: { stack: { description: @stack.description, title: @stack.title } }, as: :json
    end
  ...
  test "should update stack" do
    patch stack_url(@stack), params: { stack: { description: @stack.description, title: @stack.title } }, as: :json
    assert_response 200
  end
